...
download JP Morgan historical stock data from 2010 to 2025, covering descriptive statistics, return distributions, and basic risk metrics (VaR, normality tests)/n
Merge it with Fama-French mulyi-factor model. Using 'statsmodels' OLS regression to build single and multifactor models/n
